...
class AASEndPointHandler(AASEndPointHandler):
    ...
    def configure(self):
        ...
        drv_rst_api.add_resource(SkillMaintainer,"/shells/<path:aasIdentifier>/aas/skills/<path:skillName>/skill", resource_class_args=tuple([self.pyaas]))
