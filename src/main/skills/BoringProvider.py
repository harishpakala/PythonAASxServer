...
class sendingProposal(AState):
    ...
    def addPropertyElems(self,oSubmodel1):
        oSubmodel1 = oSubmodel1
        iSubmodel1 = self.GetSubmodelById('https://example.com/ids/sm/2334_7040_1122_4553')
        i = 0
    ...
    def create_outbound_message(self,msg_type) -> list:
        ...
        security = self.GetSubmodelELementByIdshoortPath('urn_BoringProvider:IDiS:AG2:Pilot:NormAAS:ID:Submodel:StandardContent:62443', 'ProvisionSet-SAL-C')
        bsubmodel = self.addPropertyElems(callForProposal["interactionElements"][0])
        oMessage_Out["interactionElements"].append(bsubmodel)
